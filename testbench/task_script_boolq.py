...
def main():
    ...
    for batch in tqdm(data_loader, desc="Evaluating BoolQ", disable=args.disable_tqdm, file=tqdm_file):
        ...
        with torch.no_grad():
            ...
            if total_questions <= 5:
                ...
                print(f"True Answer: {choices[true_label]}")
                print(f"Predicted Answer (acc): {choices[predicted_choice_idx]}")
                print(f"Predicted Answer (acc_norm): {choices[predicted_choice_idx_norm]}")
                print("-" * 30)

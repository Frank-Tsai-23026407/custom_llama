...
def main():
    parser = argparse.ArgumentParser(description="Lightweight OpenBookQA Evaluation Script")
    ...
    print("\nStarting evaluation...")
    TU.evaluate_obqa(model, tokenizer, device, max_samples=args.max_samples)

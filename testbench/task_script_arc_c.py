...
def main():
    parser = argparse.ArgumentParser(description="Lightweight ARC-Challenge Evaluation Script")
    ...
    print("\nStarting evaluation...")
    TU.evaluate_arc(model, tokenizer, device, variant="Challenge", max_samples=args.max_samples)

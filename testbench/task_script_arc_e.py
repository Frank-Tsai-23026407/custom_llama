...
def main():
    parser = argparse.ArgumentParser(description="Lightweight ARC-Easy Evaluation Script")
    ...
    print("\nStarting evaluation...")
    TU.evaluate_arc(model, tokenizer, device, variant="Easy", max_samples=args.max_samples)

...
def main():
    parser = argparse.ArgumentParser(description="Evaluate TinyLlama on ARC-Easy with optional BFP quantization.")
    ...
    for batch in tqdm(data_loader, desc="Evaluating ARC-Easy"):
